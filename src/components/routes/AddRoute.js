        ...
        right: '0px', zIndex: '100',
            ...
            <Grid style={{ padding: '5px 0px', borderRadius: '5px', width: '40%', background: '#F6F8FA', margin : '10% auto 0px auto'}}>
                <Grid style={{ 
                    ...
                    <Input style={{color: '#A2302F'}} placeholder='Start point'/>
                    <Input style={{color: '#A2302F'}} type='number' placeholder='Destination'/>
                </Grid>
                <Grid style={{ 
                    width: '80%', padding: '50px 30px',
                                display: 'flex', 
                                margin: 'auto', justifyContent: 'space-between'}}>
                    <Input style={{color: '#A2302F'}} placeholder='Route Code'/>
                </Grid>
